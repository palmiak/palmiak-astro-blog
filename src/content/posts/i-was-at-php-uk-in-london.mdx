...
It was a marathon, first the [JS World in Amsterdam](statamic://entry::8e96481e-20d5-412e-9360-516db90b65e4) and now **PHP UK** in London. PHP UK is considered the biggest PHP event in Europe, so I was very eager to be there both because of my work but also because  PHP is my favorite language.
