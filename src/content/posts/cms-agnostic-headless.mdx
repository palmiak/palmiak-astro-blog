...
excerpt: "Switching headless CMSs should be easy in theory — but in practice, it's always annoying. So I built a proof of concept to fix that."
description: "How to build a CMS-agnostic headless setup with Astro using an abstraction layer — a proof-of-concept for switching between headless CMSs without rewriting your whole frontend."
pubDate: 2023-11-24
