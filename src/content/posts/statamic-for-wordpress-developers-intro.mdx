...
excerpt: "If your WordPress stack looks like Bedrock + Timber + ACF + Tailwind, Statamic might feel surprisingly familiar. Here's why I started this series."
description: "Introduction to a Statamic series for WordPress developers — why Statamic appeals to WP devs, key similarities and differences, and what the series will cover."
pubDate: 2024-01-16
...
Apart from the fact that I promised myself to write [20 articles on this blog](https://maciekpalmowski.dev/blog/goals/2024/), I think that **Statamic** is just a great CMS that doesn't get all the attention it should get. Also, learning something new and exploring new worlds is valuable for every developer. I hope that even if you don't fall in love with **Statamic** as I did, you'll discover some solutions that WordPress doesn't have and create a plugin to fix it.
