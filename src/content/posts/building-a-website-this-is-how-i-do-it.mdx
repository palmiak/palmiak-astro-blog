...
I mentioned that **WordPress** has some flaws. Especially the maintenance part doesn't sound too good. We can solve it by going headless or static. I already wrote a bit about this [here](https://maciekpalmowski.dev/is-it-worth-converting-your-wordpress-to-headless/).
...
[**Statamic**](https://maciekpalmowski.dev/when-using-statamic-over-wordpress-is-a-good-idea/)[ is my personal favorite](https://maciekpalmowski.dev/when-using-statamic-over-wordpress-is-a-good-idea/) when it comes to CMSs. I really enjoy working with it. Even this blog is created with Statamic. 
