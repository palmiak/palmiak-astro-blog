...
Some time ago, I created this simple action that [prevents deploying on Fridays](https://maciekpalmowski.dev/no-deploy-friday-action/). Let's try to convert it into a Custom Action.
