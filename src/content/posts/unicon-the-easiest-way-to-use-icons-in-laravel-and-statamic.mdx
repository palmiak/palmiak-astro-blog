...
excerpt: "Managing icons in Statamic used to mean downloading files manually — Unicon fixes that with one simple Blade component and Iconify behind the scenes."
description: "How to use Unicon to manage icons in Laravel and Statamic — install the package, use Iconify icon sets with a single component, no manual downloads needed."
pubDate: 2024-11-29
