...
excerpt: "Headless vs monolith, SaaS vs self-hosted, Git-based vs database — there are more CMS flavors than you might think. Here's how to tell them apart."
description: "A guide to the different types of CMS: headless vs monolith, self-hosted vs SaaS, Git-based vs database — with pros, cons, and when to use each approach."
pubDate: 2023-08-16
...
<Alert>
You should also check my article <strong><a class="underline" href="https://maciekpalmowski.dev/blog/is-going-headless-worth-the-fuss/" target="blank">about headless</a></strong>.
</Alert>
