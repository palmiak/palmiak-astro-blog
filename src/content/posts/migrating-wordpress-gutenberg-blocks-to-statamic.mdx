...
excerpt: "Most WordPress-to-Statamic migration guides pretend Gutenberg doesn't exist. This one doesn't — here's how to handle block content properly."
description: "How to migrate WordPress Gutenberg blocks to Statamic Bard sets — a step-by-step guide using a custom CLI command to handle block-based content migration."
pubDate: 2024-08-20
