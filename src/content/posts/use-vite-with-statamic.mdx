...
excerpt: "Build times dropped from 9 seconds to 4 after switching from Laravel Mix to Vite in Statamic. Here's exactly how I did it."
description: "How to migrate a Statamic project from Laravel Mix to Vite — step-by-step instructions covering package.json, vite.config.js, and Antlers template updates."
pubDate: 2022-08-17
