...
Around 6 months earlier, I wrote an article about using [Astro Starlight](/blog/building-a-documentation-site-using-astro-starlight/). Back then we introduced a new [documentation](https://docs.patchstack.com/) page at Patchstack. Some time later we also introduced an [Academy](https://patchstack.com/academy/welcome/) page.
