...
const pages: Record<string, { title: string; description: string }> = {
  home: {
    ...
    description: 'Web developer, public speaker, Open Source enthusiast.',
  },
  blog: {
    title: 'Blog',
    description: 'Articles about WordPress, PHP, headless architecture, and Astro.',
  },
  contact: {
    title: 'Contact me',
    description: 'Ways to get in touch with Maciek Palmowski.',
  },
};
